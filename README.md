...
Não existe cadastro de Organizador pela interface — o login (telefone + senha) já pressupõe uma conta existente. Crie a primeira com:
...
A senha inicial é os 4 últimos dígitos do telefone informado (trocável em `/conta/trocar-senha` depois de logar em `/login`).
